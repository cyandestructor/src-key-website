 ...
 * @author delli
 */
@WebServlet(name = "Newsboard", urlPatterns = {"/Newsboard"})
public class Newsboard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null){
            articles = ArticleDAO.GetMarkedArticles(user.getId());
        }
        ...
        request.setAttribute("markedArticles", articles);
        
        request.getRequestDispatcher("newsboard.jsp").forward(request, response);
    }
