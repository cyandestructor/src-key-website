        ...
        <div class="page-container page-background bg-dark-page"">
            <div class=" page-content mx-auto py-4 bg-white">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div id="articleImages" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <%
                                        boolean first = true;
                                        for (Multimedia multimedia : currentArticle.getArticleMultimedia()) {
                                            if (multimedia.getFileType() == 'i') {
                                    %>
                                    <div class="carousel-item <%= first ? "active" : ""%>">
                                        <img class="article-banner" src="/images/<%= multimedia.getPath()%>" alt="First slide">
                                    </div>
                                    <%
                                                first = false;
                                            }
                    ...
                    <div class="row my-3">
                        <article class="col-12">
                            ...
                            <%
                                for(Multimedia multimedia : currentArticle.getArticleMultimedia()){
                                    if(multimedia.getFileType() == 'v'){
                            %>
                            <div class="video-box mb-2 text-center">
                                <video width="854" height="480" controls>
                                    <source src="/videos/<%= multimedia.getPath() %>" type="video/mp4">
                                </video>
                            </div>
                            <%
                                    }
