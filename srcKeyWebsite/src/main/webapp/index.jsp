            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link nav-hover" href="index.jsp">Home</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            <div id="highlightsCarousel" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li data-target="#highlightsCarousel" data-slide-to="0" class="active"></li>
                                    <li data-target="#highlightsCarousel" data-slide-to="1"></li>
                                    <li data-target="#highlightsCarousel" data-slide-to="2"></li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="assets/img/stock (1).jpg" class="d-block w-100" alt="...">
                                    ...
                                    <div class="carousel-item">
                                        <img src="assets/img/stock (2).jpg" class="d-block w-100" alt="...">
                                        <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div class="carousel-item">
                                        <img src="assets/img/stock (3).jpg" class="d-block w-100" alt="...">
                                        <div class="carousel-caption d-none d-md-block">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <div class="card" style="width: 18rem;">
                                            <img src="assets/img/stock (1).jpg" class="card-img-top" alt="...">
                                            <div class="card-body">
                                    ...
                                    <li>
                                        <div class="card" style="width: 18rem;">
                                            <img src="assets/img/stock (2).jpg" class="card-img-top" alt="...">
                                            <div class="card-body">
                                                <p class="card-text">Some quick example text to build on the card title and make
                                                    up the bulk of the card's content.</p>
                                            </div>
                                    ...
                                    <li>
                                        <div class="card" style="width: 18rem;">
                                            <img src="assets/img/stock (3).jpg" class="card-img-top" alt="...">
                                            <div class="card-body">
                                                <p class="card-text">Some quick example text to build on the card title and make
                                                    up the bulk of the card's content.</p>
                                            </div>
